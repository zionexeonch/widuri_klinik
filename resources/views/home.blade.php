...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            ...
            <h2>Ini Adalah Website Widuri Klinik</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            ...
                            <p>
                                Ini adalah Sistem Antrian Online Widuri Klinik dimana setiap pengunjung dapat mengambil
                                antrian Sesuai Poliklinik terlebih dahulu dari rumah
                            </p>
                    ...
                    <div class="col-lg-4">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Lokasi:</h4>
                                <p>Purwokerto, Jln. Kenanga V</p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope"></i>
                                <h4>Email:</h4>
                                <p>widuriklinik@gmail.com</p>
                            </div>

                            <div class="phone">
                                <i class="bi bi-phone"></i>
                                <h4>Telepon:</h4>
                                <p>+62 1112 2221 221</p>
                            </div>
